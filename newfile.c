...
unsigned char const	cYears   = 0x16; //BCD
...
#define bitset(var, bitno) ((var) |= (unsigned char)(1) << (bitno))
#define bitclr(var, bitno) ((var) &= ~((unsigned char)(1) << (bitno)))
#define PORTBIT(adr, bit) ((unsigned)(&adr)*8+(bit))

// объ€вление прототипов
void main2 (void);
void lcd_init (void);
void lcd_on (void);
void lcd_off (void);
...
void ReadTime();//char fullReading
...
unsigned char convDig_LCD(unsigned char dig){
	switch (dig){
		...
		case 39: return 'x';
		case 40: return 'q';
		case 41: return 0b01100001;//а
		case 42: return 0b10110010;//б
		case 43: return 0b10110011;//в
		case 44: return 0b10110100;//г
		case 45: return 0b11100011;//д
		case 46: return 0b01100101;//е
		case 47: return 0b10110101;//Є
		case 48: return 0b10110110;//ж
		case 49: return 0b10110111;//з
		case 50: return 0b10111000;//и
		case 51: return 0b10111001;//й
		case 52: return 0b10111010;//к
		case 53: return 0b10111011;//л
		case 54: return 0b10111100;//м
		case 55: return 0b10111101;//н
		case 56: return 'o';//о (eng)
		case 57: return 0b10111110;//п
		case 58: return 'p';//р (eng)
		case 59: return 'c';//с (eng)
		case 60: return 0b10111111;//т
		case 61: return 0b01111001;//у
		case 62: return 0b11100100;//ф
		case 63: return 0b01111000;//х
		case 64: return 0b11100101;//ц
		case 65: return 0b11000000;//ч
		case 66: return 0b11000001;//ш
		case 67: return 0b11100110;//щ
		case 68: return 0b11000010;//ъ
		case 69: return 0b11000011;//ы
		case 70: return 0b11000100;//ь
		case 71: return 0b11000101;//э
		case 72: return 0b11000110;//ю
		case 73: return 0b11000111;//€
		case 74: return '!';
		case 75: return '"';
		case 76: return 0b11001100;//є
		case 77: return ';';
		case 78: return '%';
		case 79: return '?';
		case 80: return '*';
		...
		case 88: return '\\';
		case 89: return '|';
		case 90: return 0b11101101;//колокольчик
		case 91: return 0b11011001;//стрелка вниз
		case 92: return 0b11011010;//стрелка вверх
...
unsigned char *GetDayOfWeek(unsigned char day){
	static unsigned char array[3] = {0,0,255};
		 if(day==1){array[1] = 57; array[0] = 55;} // пн
	else if(day==2){array[1] = 43; array[0] = 60;} // вт
	else if(day==3){array[1] = 59; array[0] = 58;} // ср
	else if(day==4){array[1] = 65; array[0] = 60;} // чт
	else if(day==5){array[1] = 57; array[0] = 60;} // пт
	else if(day==6){array[1] = 59; array[0] = 42;} // сб
	else if(day==7){array[1] = 43; array[0] = 59;} // вс
...
void TimeToInd(){
	...
	if(AdressOfNextStartCell!=240){
		...
		if(LockSignals){
			...
			DataArray[13] = 59;
			DataArray[14] = 41;
			DataArray[15] = 58; //расписание откл.
		/**/
...
//	}
	...
	while(1){
		if(new==0 && NumberOfCells!=240 && KeyCode==44){ // Delete
			KeyCode = 0;
			WriteFourBytesEE(NumberOfCells,0xFFFFFFFF);
			isDataModified = 1;
		}else if(new==0 && KeyCode==35){ // New
			KeyCode = 0;
			Scheduler(240, 1);
			isDataModified = 1;
	/*	}else if(new==0 && NumberOfCells!=240 && KeyCode==39){ // New copy
			KeyCode = 0;
			Scheduler(NumberOfCells, 1);
			isDataModified = 1;*/
			...
			for(char line = 0; line<2; line++){	
				for(int symbol = 0; symbol<16; symbol++){
					if(GlobalBlinkCycleTime==100 || modifide_digits[line][symbol]>0){
						...
						lcd_send_byte((line * 0x40 + 15 - symbol) | 0b10000000); //SetDDRAM
